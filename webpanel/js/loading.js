...
function loading() {
    ...
    var intervalId = setInterval(function() {
            ...
            if (elapsed == 0 && oldElapsed == 0) {
                ...
                newMessage("Which is acceptable, Steam is probably a bit slow today", "loadingDesc");
                ...
                newMessage("Something probably went wrong... Or there\'s a huge sale going on.", "loadingDesc");
            } else if (elapsed >= 35) {
                $("#stats-holder").fadeOut(550, function() {
                    ...
                    document.getElementById("loadingDesc").innerHTML = "Okay, we\'re calling it quits.  Either Steam is down or we\'re experiencing technical difficulties.  Try again later?";
